...
//    }
    ...
    void showDetail(int row) {
        if (row < 0 || row >= tblCards.getRowCount()) {
            // Nếu row không hợp lệ, xóa form hoặc làm gì đó
            clear();
            return;
        }

        // Lấy giá trị ID cột 0
        Object idObj = tblCards.getValueAt(row, 0);
        String maThe = (idObj != null) ? idObj.toString() : "";

        // Lấy giá trị status cột 1
        Object statusObj = tblCards.getValueAt(row, 1);
        String statusStr = (statusObj != null) ? statusObj.toString() : "";

        // Set vào txtCardId (hoặc txtId, tùy anh dùng)
        txtCardId.setText(maThe);

        // Chuyển status sang RadioButton
        switch (statusStr) {
            case "0":
                rdoOperating.setSelected(true);
                break;
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txtCardId, javax.swing.GroupLayout.PREFERRED_SIZE, 637, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addContainerGap()
